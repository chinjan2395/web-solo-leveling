...
const App = () => {
    ...
    const generateQuestsList = () => {
        const quests = [
            {
                id: 'q_code_1',
                description: 'Complete a coding task (small feature/bug fix).',
                type: 'work',
                status: 'pending',
                rewardXP: 25,
                rewardStat: 'focus'
            ...
            {
                id: 'q_code_2',
                description: 'Review 50 lines of code from a colleague.',
                type: 'work',
                status: 'pending',
                rewardXP: 20,
            ...
            {
                id: 'q_exercise_1',
                description: 'Do 15 minutes of light exercise (stretching/walk).',
                type: 'health',
                status: 'pending',
                rewardXP: 15,
                rewardStat: 'energy'
            ...
            {
                id: 'q_water_1',
                description: 'Drink 2 glasses of water. (Water icon)',
                type: 'health',
                status: 'pending',
                rewardXP: 10,
                rewardStat: 'health'
            ...
            {
                id: 'q_break_1',
                description: 'Take a 10-minute break away from screens.',
                type: 'wellbeing',
                status: 'pending',
                rewardXP: 10,
                rewardStat: 'mentalResilience'
            },
            {
                id: 'q_eyes_1',
                description: 'Apply the 20-20-20 rule (every 20 mins, look 20 feet away for 20 secs).',
                type: 'wellbeing',
                status: 'pending',
                rewardXP: 5,
                rewardStat: 'health'
            ...
            {
                id: 'q_learn_1',
                description: 'Spend 30 minutes learning a new tech concept.',
                type: 'skill',
                status: 'pending',
                rewardXP: 30,
                rewardStat: 'dexterity'
            },
            // Samsung Health related quests
            {
                id: 'q_samsung_exercise',
                description: 'Log 30 minutes of activity in Samsung Health.',
                type: 'health',
                status: 'pending',
                rewardXP: 20,
                rewardStat: 'energy'
            ...
            {
                id: 'q_samsung_water',
                description: 'Track 8 glasses of water in Samsung Health.',
                type: 'health',
                status: 'pending',
                rewardXP: 15,
                rewardStat: 'health'
            ...
            {
                id: 'q_samsung_sleep',
                description: 'Record 7-9 hours of sleep in Samsung Health.',
                type: 'health',
                status: 'pending',
                rewardXP: 25,
                rewardStat: 'mentalResilience'
            ...
            {
                id: 'q_samsung_heart',
                description: 'Check heart rate in Samsung Health (if applicable).',
                type: 'health',
                status: 'pending',
                rewardXP: 10,
                rewardStat: 'health'
    ...
    const generateDungeonList = () => {
        const dungeons = [
            {
                id: 'd_e',
                name: 'Class E Dungeon: Morning Warm-up',
                description: 'Complete a 15-minute full-body stretch or light cardio.',
                difficulty: 'Easy',
                rewardXP: 75,
                rewardPoints: 1,
                status: 'available'
            ...
            {
                id: 'd_d',
                name: 'Class D Dungeon: Deep Work Flow',
                description: 'Achieve 2 hours of uninterrupted, highly focused coding.',
                difficulty: 'Medium',
                rewardXP: 150,
                rewardPoints: 2,
                status: 'available'
            ...
            {
                id: 'd_c',
                name: 'Class C Dungeon: Code Refactoring Challenge',
                description: 'Refactor a complex legacy code section improving readability and performance.',
                difficulty: 'Hard',
                rewardXP: 250,
                rewardPoints: 3,
                status: 'available'
            ...
            {
                id: 'd_b',
                name: 'Class B Dungeon: New Feature Sprint',
                description: 'Deliver a new, impactful feature from concept to deployment.',
            ...
            {
                id: 'd_a',
                name: 'Class A Dungeon: System Architecture Design',
                description: 'Design a scalable architecture for a major system component or project.',
                difficulty: 'Extreme',
                rewardXP: 600,
                rewardPoints: 5,
                status: 'available'
            ...
            case 'focus':
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        ...
                        <path
                            d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 2a8 8 0 1 1 0 16 8 8 0 0 1 0-16zm0 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm0 2a2 2 0 1 1 0 4 2 2 0 0 1 0-4z"/>
                    </svg>
                );
            case 'energy':
                return (
            ...
            case 'creativity':
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        ...
                        <path
                            d="M12 2c-3.313 0-6 2.687-6 6 0 2.206 1.196 4.162 3 5.205V15a3 3 0 0 0 3 3h0a3 3 0 0 0 3-3v-1.795c1.804-1.043 3-2.999 3-5.205 0-3.313-2.687-6-6-6zm-1 15h2v2h-2v-2z"/>
                    </svg>
                );
            case 'health':
                return (
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100 font-inter p-4 sm:p-8 flex flex-col items-center">
            <div className="w-full max-w-4xl bg-gray-800 rounded-xl shadow-2xl p-6 sm:p-8 border border-gray-700">
                ...
                <p className="text-center text-gray-400 mb-8 text-sm">
                    Welcome, <span className="font-semibold text-blue-300">Hunter {userId?.substring(0, 8)}...</span>.
                    Optimize your daily grind!
                </p>
                ...
                <div className="mb-8 min-h-[40px] ">
                    {notifications.map((msg, index) => (
                        <div key={index}
                             className="bg-blue-900/50 text-blue-200 text-sm p-2 rounded-lg mb-2 animate-fade-in-out border border-blue-800">
                ...
                <div className="grid grid-cols-1 gap-8 mb-8"> {/* Changed to grid-cols-1 always */}
                    ...
                    <div className="bg-gray-700 p-6 rounded-lg shadow-inner border border-gray-600">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-3"> {/* Changed to grid-cols-2 with gap */}
                            {Object.entries(stats).map(([statName, value]) => (
                                <div key={statName}
                                     className="flex flex-col items-center bg-gray-800 p-3 rounded-md border border-gray-700 shadow-sm text-center">
                                    <div className="flex items-center justify-center space-x-1 mb-1">
                                        {getStatIcon(statName)}
                                        <span
                                            className="capitalize text-gray-300 font-semibold text-sm sm:text-base">{statName}:</span>
                                    </div>
                                    <div className="flex items-center space-x-1">
                                        ...
                                        {availablePoints > 0 && (
                                            <button
                                                ...
                                                className="bg-green-600 hover:bg-green-700 text-white font-extrabold py-0.5 px-2 rounded-full  transition-all duration-200 shadow-md hover:shadow-lg hover:ring-2 hover:ring-green-400 hover:ring-opacity-75 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 transform hover:scale-110"
                    ...
                    <div
                        className="w-full text-center p-3 bg-gray-700 rounded-lg border border-gray-600 shadow-md mt-0">
                        <p className="text-xl font-bold text-gray-200">Available Points: <span
                            className="text-green-400 text-2xl">{availablePoints}</span></p>
                    </div>
                                ...
                                >
                                    <div className="flex-1 mb-2 sm:mb-0 sm:mr-4">
                                        ...
                                        <p className="text-sm text-gray-400 mt-1">
                                            Reward: <span
                                            className="font-semibold text-yellow-300">{quest.rewardXP} XP</span>,
                                            +1 {quest.rewardStat}
                                        </p>
                                    </div>
                                    <div className="flex flex-wrap items-center justify-end gap-2 w-full sm:w-auto">
                                        {quest.status === 'pending' && (
                                            <button
                                                ...
                                                className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-3 rounded-full  transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 flex items-center justify-center whitespace-nowrap w-full sm:w-auto"
                                        ...
                                        {quest.status === 'pending' ? (
                                            ...
                                            <span
                                                className="text-green-400 font-bold text-sm sm:text-base px-2 py-1 rounded-md bg-green-800/30 whitespace-nowrap">
                            ...
                            >
                                <div className="flex-1">
                                    <p className={`font-bold text-lg ${dungeon.status === 'cleared' ? 'line-through text-gray-400' : 'text-orange-300'}`}>
                                        {dungeon.name} <span
                                        className="text-sm text-gray-400">({dungeon.difficulty})</span>
                                    </p>
                                    ...
                                    <p className="text-sm text-gray-400 mt-1">
                                        Reward: <span
                                        className="font-semibold text-yellow-300">{dungeon.rewardXP} XP</span>, <span
                                        className="font-semibold text-green-400">{dungeon.rewardPoints} Points</span>
                                    </p>
                                </div>
                                {dungeon.status === 'available' ? (
                                    ...
                                    <span
                                        className="mt-3 sm:mt-0 ml-0 sm:ml-4 text-orange-400 font-bold">CLEARED!</span>
                                )}
                            </div>
                        ))}
                    </div>
                ...
                <div className="bg-gray-700 p-6 rounded-lg shadow-inner border border-gray-600 mt-8">
                    ...
                    <p className="text-red-300 mb-4 text-sm font-semibold">
                        <span className="font-bold">SYSTEM NOTE:</span> Direct integration with Samsung Health is not
                        possible from this web application. Please manually enter your data below after tracking it in
                        your Samsung Health app.
                    </p>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {/* Exercise */}
                        <div className="flex flex-col">
                            <label htmlFor="exerciseDuration" className="text-gray-300 text-sm mb-1">Exercise Duration
                                (minutes)</label>
                            <input
                                type="number"
                                id="exerciseDuration"
                        ...
                        {/* Water */}
                        <div className="flex flex-col">
                            <label htmlFor="waterGlasses" className="text-gray-300 text-sm mb-1">Water Intake
                                (glasses)</label>
                            <input
                                type="number"
                                id="waterGlasses"
                ...
                <div className="bg-gray-700 p-6 rounded-lg shadow-inner border border-gray-600 mt-8">
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2">
                        <li><span className="font-semibold text-yellow-200">Hydration:</span> Aim for a glass of water
                            every hour. Keep a bottle handy!
                        </li>
                        <li><span className="font-semibold text-yellow-200">Breaks:</span> Implement the Pomodoro
                            Technique (25 mins work, 5 mins break). Stand up, stretch, look out the window.
                        </li>
                        <li><span className="font-semibold text-yellow-200">Exercise:</span> Short bursts of activity
                            throughout the day (bodyweight exercises, walking).
                        </li>
                        <li><span className="font-semibold text-yellow-200">Digital Well-being:</span> Set boundaries
                            for screen time. Avoid work emails after hours.
                        </li>
                        <li><span className="font-semibold text-yellow-200">Ergonomics:</span> Ensure your desk, chair,
                            and monitor are set up correctly to prevent strain.
                        </li>
                        <li><span className="font-semibold text-yellow-200">Learning:</span> Dedicate time daily to
                            learning new skills or technologies relevant to your work.
                        </li>
                        <li><span className="font-semibold text-yellow-200">Rest:</span> Prioritize 7-9 hours of quality
                            sleep. Your brain needs to defrag.
                        </li>
                        <li><span className="font-semibold text-yellow-200">Samsung Health:</span> Use your Samsung
                            Health app as your primary tracker, then use this system to log your completion for XP and
                            rewards!
                        </li>
                    </ul>
                </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
                    <div
                        className="bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-700 max-w-sm w-full text-left">
